...
typeMap[(DIRECTION_LONG, OFFSET_CLOSE)] = '4'
typeMap[(DIRECTION_SHORT, OFFSET_CLOSE)] = '3'
        ...
        try:
            ...
            if len(data['holding'])!=0:
                for d in data['holding'][0]:
                    ...
                    longPosition.vtSymbol = longPosition.symbol
...
class OkexfWebsocketApi(WebsocketClient):
    ...
    def onTick(self, d):
        try:
            ...
            tick.limitHigh = float(data['limitHigh'])
            tick.limitLow = float(data['limitLow'])
    ...
    def onPosition(self, d):
        try:
            ...
            for buf in data['positions']:
                ...
                position.vtSymbol = position.symbol
